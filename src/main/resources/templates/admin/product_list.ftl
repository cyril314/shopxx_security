...
<div class="body">
    <div class="listBar">
        <h1><span class="icon">&nbsp;</span>商品列表&nbsp;<span
    ...
    <form id="listForm" action="product!list.action" method="post">
        <div class="operateBar">
            ...
            <select name="pager.property">
                <option value="name" <#if pager.property! == "name">selected="selected" </#if>> 商品名称</option>
                <option value="productSn" <#if pager.property! == "productSn">selected="selected" </#if>> 货号</option>
            </select>
        ...
        <table class="listTable">
            <tr>
                ...
                <th><span class="sort" name="name">商品名称</span></th>
                <th><span class="sort" name="productSn">货号</span></th>
                <th><span class="sort" name="productCategory">分类</span></th>
                <th><span class="sort" name="price">本店价格</span></th>
                <th><span class="sort" name="isMarketable">上架</span></th>
                <th><span class="sort" name="isBest">精品</span></th>
                <th><span class="sort" name="isNew">新品</span></th>
                <th><span class="sort" name="isHot">热销</span></th>
                <th><span class="sort" name="store">库存</span></th>
                <th> 操作</th>
            </tr>
            <#list pager.list as list>
                <tr>
                    ...
                    <td>
                        <span title="被占用数: ${(list.freezeStore)}">${(list.store)!"-"}<#if list.freezeStore gte list.store > <span
                                    class="red">[缺货]</span></#if></span>
                    </td>
                    <td>
