            ...
            <form id="loginForm" class="form" action="${base!}/admin/loginVerify" method="post">
                ...
                <table class="loginTable">
                    ...
                    <tr>
                        <th> &nbsp;</th>
                        <td>
                            <input type="button" class="homeButton ignoreForm" value="" onclick="window.open('${base!}/')"
                                   hidefocus="true"/>
                            <input type="submit" class="submitButton ignoreForm" value="登 陆" hidefocus="true"/>
                            <input type="button" class="helpButton ignoreForm" value="帮 助" onclick="window.open('http://help.shopxx.net')"
                                   hidefocus="true"/>
                        </td>
                    </tr>
                </table>
