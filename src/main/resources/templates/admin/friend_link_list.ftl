    ...
    <form id="listForm" action="friend_link!list.action" method="post">
        ...
        <table class="listTable">
            <tr>
                ...
                <th><span class="sort" name="name">友情链接名称</span></th>
                <th><span class="sort" name="url">链接地址</span></th>
                <th><span class="sort" name="logo">LOGO</span></th>
                <th><span class="sort" name="orderList">排序</span></th>
            ...
            <#list pager.list as list>
                <tr>
                    ...
                    <td><a href="friend_link!edit.action?id=${list.id}" title="编辑">[编辑]</a></td>
                </tr>
            </#list>
        </table>
