			...
			<table class="listTable">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							${message("DeliveryMethod.", list.deliveryMethod)}
						</td>
						<td>
							${list.firstWeight}${message("WeightUnit.", list.firstWeightUnit)}
						</td>
						<td>
							${list.continueWeight}${message("WeightUnit.", list.continueWeightUnit)}
						</td>
						<td>
							${list.sort}
						</td>
