...
<div class="body">
    ...
    <form id="inputForm" action="/admin/build_html/all" method="post">
        ...
        <table class="inputTable">
            ...
            <tr class="dateTr">
                <th> 起始日期:</th>
                <td>
                    <input type="text" id="beginDateInput" name="" class="formText datePicker"
                           value="${(defaultBeginDate?string("yyyy-MM-dd"))!}" title="留空则从最早的内容开始更新"/>
                </td>
            </tr>
            <tr class="dateTr">
                <th> 结束日期:</th>
                <td>
                    <input type="text" id="endDateInput" name="" class="formText datePicker"
                           value="${(defaultEndDate?string("yyyy-MM-dd"))!}" title="留空则更新至最后的内容"/>
                </td>
            </tr>
            <tr>
                <th> 每次更新数</th>
