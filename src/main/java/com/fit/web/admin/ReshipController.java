...
import com.fit.entity.Reship;
import com.fit.service.ReshipService;
...
public class ReshipController extends BaseController {
    ...
    public String list(HttpServletRequest request) {
        ...
        List<Reship> lists = this.reshipService.findList(map);
        pager.setList(lists);
