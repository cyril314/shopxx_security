...
public class OsCacheConfigUtil {
    ...
    public static final String GENERAL_CACHE_BEAN_NAME = "cacheManager";
    ...
    public static Object getFromCache(String key) {
        GeneralCacheAdministrator generalCacheAdministrator = (GeneralCacheAdministrator) SpringUtil.getBean(GENERAL_CACHE_BEAN_NAME);
        Object object = null;
        try {
