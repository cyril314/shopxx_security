...
import com.fit.bean.SystemConfig.CurrencyType;
import com.fit.bean.SystemConfig.PointType;
import com.fit.bean.SystemConfig.RoundType;
import com.fit.bean.SystemConfig.StoreFreezeTime;
import com.fit.bean.SystemConfig.WatermarkPosition;
...
public class SystemConfigUtil {
    ...
    public static void update(SystemConfig systemConfig) {
        ...
        shopUrlNode.setText(removeEnd(systemConfig.getShopUrl(), "/"));
